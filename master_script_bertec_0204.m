%This script works with both Comparison and Prototype data FOR AA02 and AA04 ONLY, but only MATLAB
...
%% Determination of Ankle/Knee Markers for Comparison/Prototype Foot
